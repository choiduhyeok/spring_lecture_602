										...
										<td align="center"><table width="400" border="0"
												...
												<tr>													
													...
													<td width="290"><input type='hidden' name='sndStoreid'
														value='2999199999' size='15' maxlength='10'></td>
												</tr>
												<tr bgcolor="#E3E3E3">
													<td height="1" colspan="2"></td>
												</tr>
												<tr>
													...
													<td width="290"><input type='text'
														name='sndOrdernumber' value='carrot_1234' size='30'></td>
												</tr>
												<tr bgcolor="#E3E3E3">
													<td height="1" colspan="2"></td>
												</tr>
									...
									<tr>
										<td align="center"><table width="400" border="0"
												...
												<tr>
													<td width="110"><img
														src="http://kspay.ksnet.to/store/KSPayFlashV1.3/mall/imgs/ico_right.gif"
														width="11" height="11" align="absmiddle"> 강의명</td>
												...
												<tr>
													<td width="110"><img
														src="http://kspay.ksnet.to/store/KSPayFlashV1.3/mall/imgs/ico_right.gif"
														width="11" height="11" align="absmiddle"> 수강료</td>
													<!--금액은 ,없이 입력 -->
												...
												<tr>
													<td width="110"><img
														src="http://kspay.ksnet.to/store/KSPayFlashV1.3/mall/imgs/ico_right.gif"
														width="11" height="11" align="absmiddle"> 신청자</td>
