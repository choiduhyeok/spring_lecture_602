...
public class LoginSuccessSecurityHandler 
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		HandlerInterceptorAdapter loginInterceptor
		= (HandlerInterceptorAdapter)ctx.getBean("loginUserLogInterceptor");

		try {
			loginInterceptor.postHandle(request, response, null, null);
		} catch (Exception e1) {
